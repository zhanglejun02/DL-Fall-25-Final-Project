...
from .hmt_projector import HMTProjector
            ...
            for p in group["params"]:
                ...
                if "rank" in group:
                    ...
                    #         state["projector"] = GaLoreProjectorTensor(group["rank"], update_proj_gap=group["update_proj_gap"], scale=group["scale"], proj_type=group["proj_type"])
                        state["projector"] = HMTProjector(group["rank"], update_proj_gap=group["update_proj_gap"], scale=group["scale"], proj_type=group["proj_type"])
