...
from .galore_projector import GaLoreProjector as GradientProjector
            ...
            for p in group["params"]:
                ...
                if "rank" in group:
                    if "projector" not in state:
                        state["projector"] = GradientProjector(group["rank"], update_proj_gap=group["update_proj_gap"], scale=group["scale"], proj_type=group["proj_type"])
